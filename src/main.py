...
class Main:
    ...
    también debería funcionar correctamente con los derivados de Ubuntu 18.04.
    """, use_aliases=True
            )
        )
    ...
    por en consecuencia no se garantiza que estén actualizados al dia; Sin embargo los paquetes
